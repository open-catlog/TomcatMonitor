...
public class TomcatModel extends BaseModel {
	...
	public TomcatModel(String server, int maxThreads, int currentThreadCount, int currentThreadsBusy, long collectionCount,
			long collectionTime, long startTime, long uptime) {
